package philips.com.myapplication.handler;
...
import philips.com.myapplication.ui.fragment.SuggestionFragment;
...
public class ViewPagerHandler extends Handler {
    ...
    private WeakReference<SuggestionFragment> weakReference;
    private int currentItem = 0;

    public ViewPagerHandler(WeakReference<SuggestionFragment> wk){
        weakReference = wk;
    }
...
//        Log.d(LOG_TAG, "receive message " + msg.what);
        SuggestionFragment fragment = weakReference.get();
        if (fragment==null){
